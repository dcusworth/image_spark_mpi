...
We first benchmark the serial implementation on Odyssey for different problem sizes. The code used for this is included in [Code_Serial.py](https://github.com/dcusworth/image_spark_mpi/model/ML_algorithm_MNIST_Serial.ipynb). As shown in the Figure below, we find that runtime scales linearly with the number of samples studied. The model reaches above 70% accuracy for the larger training sets. 

![Serial-Runtimes](https://github.com/dcusworth/image_spark_mpi/blob/master/img/Sizes_Serial.png)
...
![OpenMP-Runtimes](https://github.com/dcusworth/image_spark_mpi/blob/master/img/Runtime_OpenMP.png)
...
![OpenMP-Speedups](https://github.com/dcusworth/image_spark_mpi/blob/master/img/Speedup_OpenMP.png)
...
![Spark-Speedups](https://github.com/dcusworth/image_spark_mpi/blob/master/img/Speedup_Spark.png)
